            ...
            <ul class="nav navbar-nav">
                &nbsp;<li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{url('/treads/')}} ">All Threads</a></li>
                        @if(auth()->check())
                            <li><a href="{{url('/treads?by=')}}{{ auth()->user()->name}} ">My Threads</a></li>
                        @endif
                        <li><a href="{{url('/treads?popular=1')}}">Popular Threads</a></li>
                        <li><a href="{{url('/treads?unanswered=1')}}">Unanswered Threads</a></li>
                    </ul>
                </li>
                <li><a href="{{url('/treads/create')}}">New Thread</a></li>
